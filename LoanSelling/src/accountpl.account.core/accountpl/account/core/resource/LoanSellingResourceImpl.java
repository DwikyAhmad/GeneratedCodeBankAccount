...
public class LoanSellingResourceImpl extends LoanSellingResourceComponent {
    ...
    static interface LoanSellingService {
        void transfer(Map<String, Object> requestBody, String processid, Map<String, Object> response);

    }

    static class LoanSellingServiceImpl implements LoanSellingService {
	    @Override
	...
	private static LoanSellingService loansellingService = new LoanSellingServiceImpl();
    ...
    public Map<String, Object> transfer(VMJExchange vmjExchange) {
		...
		loansellingService.transfer(requestBody, processid, response);
