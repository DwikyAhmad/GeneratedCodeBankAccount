...
public class TanpadlResourceImpl extends TanpadlResourceComponent {
    ...
    static interface TanpadlService {
        void transfer(Map<String, Object> requestBody, String processid, Map<String, Object> response);

    }

    static class TanpadlServiceImpl implements TanpadlService {
	    @Override
	...
	private static TanpadlService tanpadlService = new TanpadlServiceImpl();
    ...
    public Map<String, Object> transfer(VMJExchange vmjExchange) {
		...
		tanpadlService.transfer(requestBody, processid, response);
