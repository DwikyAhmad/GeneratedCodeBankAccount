...
import accountpl.account.DlfrequencyResourceFactory;
...
public class Mybank {
	...
	public static void createObjectsAndBindEndPoints() {
		...
		DlfrequencyResourceImpl dlfrequencyresource = DlfrequencyResourceFactory.createResource("accountpl.account.core.resource.DlfrequencyResourceImpl");
		Router.route(dlfrequencyresource);
		System.out.println("DlfrequencyResource endpoints binding");
		dlfrequencyresource.accountAccount2Service = accountAccount2Service;
		dlfrequencyresource.dailylimitAccount2Service = dailylimitAccount2Service;
