...
public class DlfrequencyResourceImpl extends DlfrequencyResourceComponent {
    ...
    static interface DlfrequencyService {
        void transfer(Map<String, Object> requestBody, String processid, Map<String, Object> response);

    }

    static class DlfrequencyServiceImpl implements DlfrequencyService {
	    @Override
	...
	private static DlfrequencyService dlfrequencyService = new DlfrequencyServiceImpl();
    ...
    public Map<String, Object> transfer(VMJExchange vmjExchange) {
		...
		dlfrequencyService.transfer(requestBody, processid, response);
